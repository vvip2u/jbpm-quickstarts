package com.ebao.ls.workflow.jbpm.gateway.demo.parallel;
...
@Slf4j
public class ParallelDemoMain {

    public static final void main(String[] args) throws Exception {
            
            KieHelper kieHelper = new KieHelper();
            KieBase kieBase = kieHelper.addResource(
                            ResourceFactory.newClassPathResource(PARALLEL_BPMN_FILE))
                            .build();
            ...
            KieRuntimeLogger logger = KieServices.Factory.get()
                                                                    .getLoggers().newFileLogger(ksession, PARALLEL_PROCESS_ID);
            
            ProcessInstance processInstance = ksession.startProcess(PARALLEL_PROCESS_ID);
